...
local window = library:CreateWindow("Bugjah | [Update 1.5] Project Slayers", Enum.KeyCode.RightControl)
local Watermark = library:CreateWatermark("Bugjah | [Update 1.5] Project Slayers | {fps}")
...
Credits:AddButton("Copy User Discord",function()
    setclipboard("Doublxfex#6686")
    end)
...
Settings:AddDropdown("Kill Aura Method", {"Scythe","Sword","Combat","Claw","Fans"}, "Sword", false, function(v)
    getgenv().Method = v
end)
...
Misc:AddButton("War Drums - All Races",function()
...
--Teleports
Teleports:AddDropdown("Trainers", {"Flame Trainer","Mist Trainer","Beast Trainer","Sound Trainer","Snow Trainer"}, "Trainer", false, function(v)
    getgenv().TrainerSelected = v
end)
